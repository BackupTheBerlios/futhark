...
// 	var lift1 = function (f) {
// 	    return function (x) {
// 		return apply (lift0 (f), liftArray ([x]));
// 	    };
// 	};
 	         
// 	var lift2 = function (f) {
// 	    return function (x, y) {
// 		return apply (lift0 (f), liftArray ([x, y]));
// 	    }
// 	}   

// 	var lift3 = function (f) {
// 	    return function (x, y, z) {
// 		return apply (lift0 (f), liftArray ([x, y, z]));
// 	    }
// 	}
   
// 	var lift4 = function (f) {
// 	    return function (x, y, z, w) {
// 		return apply (lift0 (f), liftArray ([x, y, z, w]));
// 	    }
// 	}

// 	var lift5 = function (f) {
// 	    return function (x, y, z, w, k) {
// 		return apply (lift0 (f), liftArray ([x, y, z, w, k]));
// 	    }
// 	}
